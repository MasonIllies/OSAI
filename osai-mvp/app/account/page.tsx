      ...
      {!authed ? (
        ...
        <div className="flex gap-4 items-center">
          <button
            onClick={openPortal}
            disabled={loading}
            className="inline-flex items-center justify-center rounded-xl px-4 py-2 text-base font-semibold border border-white/15 shadow-sm hover:opacity-90 focus:outline-none focus:ring disabled:opacity-50"
          >
