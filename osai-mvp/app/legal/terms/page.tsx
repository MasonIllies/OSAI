export default function Terms() {
  return (
    <section className="prose prose-invert max-w-none">
      ...
      <p>Plans: <strong>Basic Control</strong> and <strong>Locked In.</strong> Cancel anytime in the billing portal.</p>
      <h2>3. Refunds</h2>
      ...
      <h2>5. Liability</h2>
      <p>Service is provided “as is”; liability limited to fees paid in the last 12 months.</p>
      <h2>6. Contact</h2>
