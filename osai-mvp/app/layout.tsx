...
export const metadata: Metadata = {
  ...
  openGraph: { title: "OSAI", description: "Always-on AI control for your life and work.", url: "https://osai.llc", siteName: "OSAI", type: "website" },
    ...
    <html lang="en" className="h-full">
      <body className="min-h-screen bg-black text-white antialiased">
        ...
        <header className="sticky top-0 z-40 backdrop-blur-md bg-black/30 border-b border-white/10">
          <nav className="container mx-auto max-w-6xl px-4 sm:px-6 lg:px-8 h-14 flex items-center justify-between">
            <Link href="/" className="flex items-center gap-3">
              {/* swap to your PNG in /public (next step) */}
        ...
        {/* PAGE CONTENT */}
        <main id="main" className="container mx-auto max-w-6xl px-4 sm:px-6 lg:px-8 py-10">
          {children}
        </main>

        {/* FOOTER */}
        <footer className="border-t border-white/10">
          <div className="container mx-auto max-w-6xl px-4 sm:px-6 lg:px-8 py-8 text-sm flex flex-col md:flex-row items-center justify-between gap-4 text-white/70">
